...
function App() {
  ...
  const BookmakerDropdown = ({ show, items }) => (
    show && (
      <div className="absolute right-0 mt-2 w-80 bg-[#f0fff0] rounded-lg shadow-xl overflow-hidden z-50">
        {items.map((bookmaker, index) => (
          <a
            ...
            className="block p-4 hover:bg-[#e0ffe0] transition-colors duration-200"
          >
